...
{
    const typesSet = new Set(transactions.map(t => t.transaction_type));
...
console.log("unique:", getUniqueTransactionTypes(transactions));

console.log("Total Amount:", calculateTotalAmount(transactions));

console.log("Feb 2019 Total:", calculateTotalAmountByDate(transactions, 2019, 2));
